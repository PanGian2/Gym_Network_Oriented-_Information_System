            ...
            <div class="col-6 offset-3">
                <form action="../../../utils/submitData.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="username" name="username" value="<?php echo $data->username; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="email">Email</label>
                        <div class="input-group">
                            <span class="input-group-text" id="email-label">@</span>
                            <input type="text" class="form-control" id="email" aria-label="email" aria-describedby="email-label" name="email" value="<?php echo $data->email; ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="country">Χωρα</label>
                        <select class="form-select" id="country" name="country" onchange='getOption();' required>
                            ...
                            $country = $result["data"];
                            // Output countries as options for the select element
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="cancellations">Ακυρώσεις</label>
                        <input class="form-control" type="number" min="0" max="2" id="cancellations" name="cancellations" value="<?php echo $data->cancellations; ?>" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="type" name="type" required>
                            <?php
                            if ($data->type == "simple") {
                                echo "<option selected value='simple'>Απλός</option>";
                                echo "<option value='admin'>Διαχειριστής</option>";
                            } else {
                                echo "<option selected value='admin'>Διαχειριστής</option>";
                                echo "<option value='simple'>Απλός</option>";
                            }
                            ?>
                        </select>
                    </div>
